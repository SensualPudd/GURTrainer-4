...
package _4_0 
{
	...
	public class ScoreScreen3 extends MenuWorld
	{
		public var menu_button:MenuButton = null;
		
		public function ScoreScreen3 ()
		{
			super ();
		}
		...
		override public function init () : void
		{
			...
			text = new Text ("Segment " + _4_0.Main.instance.v.level_segment + " time", 160, 75);
			text.color = 16777215;
			text.size = 8;
			text.center ();
			...
			text = new Text (_4_0.Main.instance.Time (_4_0.Main.instance.TimeLevelSegment (_4_0.Main.instance.v.level_segment.split ("-") [0], _4_0.Main.instance.v.level_segment.split ("-") [1], Main.instance.config.OPTIONS.SHOW_SEGMENT_TIME)), 160, 90);
			text.color = 16777215;
			text.size = 16;
			text.center ();
			...
			text = new Text ("Best " + _4_0.Main.instance.v.level_segment + " Segment", 160, 110);
			text.color = 16777215;
			text.size = 8;
			text.center ();
			...
			text = new Text (_4_0.Main.instance.Time (_4_0.Main.instance.statz.LEVELS_SEGMENT [_4_0.Main.instance.v.level_current.mode]["_" + _4_0.Main.instance.v.level_segment.split ("-").join ("_")]), 160, 125);
			text.color = 16777215;
			text.size = 16;
			text.center ();
		...
		public function Next (menu_button:MenuButton) : ScoreScreen3 
		{
